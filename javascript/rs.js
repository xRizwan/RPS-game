...
choices.forEach((choices) => {
    choices.addEventListener("click", (e) => {
        ...
        displayChosen.innerHTML = `<i>You</i> Chose ${chosen}! <br> <i>Computer</i> Chose ${computer}`;
        ...
        if (checking === "Loss"){
            ...
            content = `${computer.toUpperCase()} beats ${chosen.toUpperCase()}! <br> You LOSE!`;
            ...
            content = `${chosen.toUpperCase()} beats ${computer.toUpperCase()}! <br> You WIN!`;
            resultdiv.innerHTML = content;
            resultdiv.classList.add("result");
            body.appendChild(resultdiv);
